<div class="form-group text-right">
    <?php if($this->permission->method('company', 'create')->access()): ?>
    <button type="button" class="btn btn-primary btn-md" data-target="#add0" data-toggle="modal"><i class="fa fa-user-plus" aria-hidden="true"></i> <?php echo display('add_company') ?></button>
    <?php endif; ?> 
</div>
                ...
                <table width="100%" class="datatable table table-striped table-bordered table-hover">
                    <thead>
                        <tr>
                            ...
                            <th>
                                <?php echo display('company_phone') ?>
                            </th>
                            <th>
                                <?php echo display('company_email') ?>
                            </th>
                            <th>
                                <?php echo display('company_picture') ?>
                            </th>
                            <th>
                            ...
                            <?php $sl = 1; ?>
                                <?php foreach ($agen as $query) { ?>
                                    <tr>
                                        ...
                                        <td>
                                         <a href="<?php echo base_url("company/company_controller/company_ledger/$query->company_id") ?>"><?php echo $query->company_first_name.' '.$query->company_second_name; ?></a>    
                                        </td>
                                        <td>
                                            <?php echo $query->company_name; ?>
                                        </td>
                                        <td>
                                            <?php echo $query->company_phone; ?>
                                        </td>
                                        <td>
                                            <?php echo $query->company_email; ?>
                                        </td>
                                        <td>
                                            <?php echo "<img src='" . base_url().$query->company_picture."' width=60px; height=60px; class=img-thumbnail>";?>
                                        </td>

                                        <td> 
                                            <?php if($this->permission->method('company','read')->access()): ?>
                                            <a href="<?php echo base_url("company/company_controller/company_details/$query->company_id") ?>" class="btn btn-xs btn-default"><i class="fa fa-eye"></i></a>
                                            <?php endif; ?>

                                            <?php if($this->permission->method('company','update')->access()): ?>
                                            <a href="<?php echo base_url("company/company_controller/company_update/$query->company_id") ?>" class="btn btn-xs btn-success"><i class="fa fa-pencil"></i></a> 
                                            <?php endif; ?>

                                            <?php if($this->permission->method('company','delete')->access()): ?>
                                            <a href="<?php echo base_url("company/company_controller/company_delete/$query->company_id") ?>" class="btn btn-xs btn-danger" onclick="return confirm('<?php echo display('are_you_sure') ?>') "><i class="fa fa-times" aria-hidden="true"></i>
                                            </a> 
                                            <?php endif; ?>
                                        </td>
                                    </tr>
                    ...
                    <div class="col-sm-12 col-md-12">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <?= form_open_multipart('company/company_controller/create_company') ?>
                                    <div class="form-group row">
                                        <div for="company_first_name" class="col-sm-2 col-form-div">
                                            <?php echo display('company_first_name') ?> *
                                        </div>
                                        <div class="col-sm-4">
                                            <input name="company_first_name" class="form-control" type="text" placeholder="<?php echo display('company_first_name') ?>" id="company_first_name">
                                        </div>
                                        <div for="company_second_name" class="col-sm-2 col-form-div">
                                            <?php echo display('company_second_name') ?> *</div>
                                        <div class="col-sm-4">
                                            <input name="company_second_name" class="form-control" type="text" placeholder="<?php echo display('company_second_name') ?>" id="company_second_name">
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <div for="company_phone" class="col-sm-2 col-form-div">
                                            <?php echo display('company_phone') ?> *</div>
                                        <div class="col-sm-4">
                                            <input name="company_phone" class="form-control" type="text" placeholder="<?php echo display('company_phone') ?>" id="company_phone">
                                        </div>
                                        <div for="company_mobile" class="col-sm-2 col-form-div">
                                            <?php echo display('company_mobile') ?>
                                        </div>
                                        <div class="col-sm-4">
                                            <input name="company_mobile" class="form-control" type="text" placeholder="<?php echo display('company_mobile') ?>" id="company_mobile">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div for="company_name" class="col-sm-2 col-form-div">
                                            <?php echo display('company_name') ?>
                                        </div>
                                        <div class="col-sm-4">
                                            <input name="company_name" class="form-control" type="text" placeholder="<?php echo display('company_name') ?>" id="company_name">
                                        </div>
                                        <div for="company_document_id" class="col-sm-2 col-form-div">
                                            <?php echo display('company_document_id') ?> </div>
                                        <div class="col-sm-4">
                                            <input name="company_document_id" class="form-control" type="text" placeholder="<?php echo display('company_document_id') ?>" id="company_document_id">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div for="company_pic_document" class="col-sm-2 col-form-div">
                                            <?php echo display('company_pic_document') ?> </div>
                                        <div class="col-sm-4">
                                            <input name="company_pic_document" class="form-control" type="file" placeholder="<?php echo display('company_pic_document') ?>" id="company_pic_document">
                                        </div>
                                        <div for="company_picture" class="col-sm-2 col-form-div">
                                            <?php echo display('company_picture') ?></div>
                                        <div class="col-sm-4">
                                            <input name="company_picture" class="form-control" type="file" placeholder="<?php echo display('company_picture') ?>" id="company_picture">
                                        </div>

                                    </div>
                                    <div class="form-group row">
                                        <div for="company_email" class="col-sm-2 col-form-div">
                                            <?php echo display('company_email') ?>
                                        </div>
                                        <div class="col-sm-4">
                                            <input name="company_email" class="form-control" type="email" placeholder="<?php echo display('company_email') ?>" id="company_email" onkeyup="logdata(this.value)" required>
                                        </div>
                                        <div for="company_address_line_1" class="col-sm-2 col-form-div">
                                            <?php echo display('company_address_line_1') ?> </div>
                                        <div class="col-sm-4">
                                            <textarea name="company_address_line_1" class="form-control" placeholder="<?php echo display('company_address_line_1') ?>" id="company_address_line_1"></textarea>
                                        </div>

                                    </div>
                                    <div class="form-group row">
                                        <div for="company_address_line_2" class="col-sm-2 col-form-div">
                                            <?php echo display('company_address_line_2') ?>
                                        </div>
                                        <div class="col-sm-4">
                                            <textarea name="company_address_line_2" class="form-control" placeholder="<?php echo display('company_address_line_2') ?>" id="company_address_line_2"></textarea>
                                        </div>
                                        <div for="company_country" class="col-sm-2 col-form-div">
                                            <?php echo display('company_country') ?></div>
                                        <div class="col-sm-4">
                                            <select name="company_country" class="form-control" style="width: 100%">
                                    ...
                                    <div class="form-group row">
                                        <div for="company_address_city" class="col-sm-2 col-form-div">
                                            <?php echo display('company_address_city') ?>
                                        </div>
                                        <div class="col-sm-4">
                                            <input name="company_address_city" class="form-control" type="text" placeholder="<?php echo display('company_address_city') ?>" id="company_address_city">

                                        </div>
                                        <div for="company_address_zip_code" class="col-sm-2 col-form-div">
                                            <?php echo display('company_address_zip_code') ?>
                                        </div>
                                        <div class="col-sm-4">
                                            <input name="company_address_zip_code" class="form-control" type="text" placeholder="<?php echo display('company_address_zip_code') ?>" id="company_address_zip_code">
                                        </div>
                                     ...
                                     <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <input name="company_address_city" class="form-control" type="text" placeholder="<?php echo display('email') ?>" id="log_email" readonly>
...
<script type="text/javascript">
    $(document).ready(function() {
        var $cat = $('select[name=company_country]'),
            $items = $('select[name=company_address_city]'),
            $zip = $('select[name=company_address_zip_code]');
        $cat.change(function() {
