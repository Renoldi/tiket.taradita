<div class="form-group text-right">  
    <?php if($this->permission->module('company','read')->access()): ?>
    <a href="<?php echo base_url();?>company/company_controller/create_company" class="btn btn-primary"><?php echo display('company_list') ?></a>
    <?php endif; ?>
</div>
    ...
    <div class="col-sm-12 col-md-12">
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                <?php echo img($data->company_picture, 'height="120px"','width="120px"') ;?>
                    <?= form_open_multipart('company/company_controller/company_update/'. $data->company_id) ?>

                        <input type="hidden" name="company_id" value="<?php echo $data->company_id;?>">

                        <div class="form-group row">
                            <label for="company_first_name" class="col-sm-2 col-form-label">
                                <?php echo display('company_first_name') ?> *
                            </label>
                            <div class="col-sm-4">
                                <input name="company_first_name" class="form-control" type="text" placeholder="<?php echo display('company_first_name') ?>" id="company_first_name" value="<?php echo $data->company_first_name;?>">
                            </div>
                            <label for="company_second_name" class="col-sm-2 col-form-label">
                                <?php echo display('company_second_name') ?> *</label>
                            <div class="col-sm-4">
                                <input name="company_second_name" class="form-control" type="text" placeholder="<?php echo display('company_second_name') ?>" id="company_second_name" value="<?php echo $data->company_second_name;?>">
                            </div>
                        </div>

                        <div class="form-group row">
                            <label for="company_phone" class="col-sm-2 col-form-label">
                                <?php echo display('company_phone') ?> *</label>
                            <div class="col-sm-4">
                                <input name="company_phone" class="form-control" type="text" placeholder="<?php echo display('company_phone') ?>" id="company_phone" value="<?php echo $data->company_phone;?>">
                            </div>
                            <label for="company_mobile" class="col-sm-2 col-form-label">
                                <?php echo display('company_mobile') ?>
                            </label>
                            <div class="col-sm-4">
                                <input name="company_mobile" class="form-control" type="text" placeholder="<?php echo display('company_mobile') ?>" id="company_mobile" value="<?php echo $data->company_mobile;?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input name="company_name" class="form-control" type="text" placeholder="<?php echo display('company_name') ?>" id="company_name" value="<?php echo $data->company_name;?>">
                            </div>
                            <label for="company_document_id" class="col-sm-2 col-form-label">
                                <?php echo display('company_document_id') ?>
                            </label>
                            <div class="col-sm-4">
                                <input name="company_document_id" class="form-control" type="text" placeholder="<?php echo display('company_document_id') ?>" id="company_document_id" value="<?php echo $data->company_document_id;?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="company_pic_document" class="col-sm-2 col-form-label">
                                <?php echo display('company_pic_document') ?>
                            </label>
                            <div class="col-sm-4">
                            ...
                            <label for="company_picture" class="col-sm-2 col-form-label">
                                <?php echo display('company_picture') ?> </label>
                            <div class="col-sm-4">
                        ...
                        <div class="form-group row">
                            <label for="company_email" class="col-sm-2 col-form-label">
                                <?php echo display('company_email') ?>
                            </label>
                            <div class="col-sm-4">
                                <input name="company_email" class="form-control" type="email" placeholder="<?php echo display('company_email') ?>" id="company_email" value="<?php echo $data->company_email;?>">
                                <input type="hidden" name="old_email" value="<?php echo $data->company_email;?>">
                            </div>
                            <label for="company_address_line_1" class="col-sm-2 col-form-label">
                                <?php echo display('company_address_line_1') ?> </label>
                            <div class="col-sm-4">
                                <textarea name="company_address_line_1" class="form-control" placeholder="<?php echo display('company_address_line_1') ?>" id="company_address_line_1"><?php echo $data->company_address_line_1;?>
                                </textarea>
                            </div>

                        </div>
                        <div class="form-group row">
                            <label for="company_address_line_2" class="col-sm-2 col-form-label">
                                <?php echo display('company_address_line_2') ?>
                            </label>

                            <div class="col-sm-4">
                                <textarea name="company_address_line_2" class="form-control" placeholder="<?php echo display('company_address_line_2') ?>" id="company_address_line_2"><?php echo $data->company_address_line_2;?>
                                </textarea>
                            </div>
                            <label for="company_country" class="col-sm-2 col-form-label">
                                <?php echo display('company_country') ?> </label>
                            <div class="col-sm-4">
                                <select name="company_country" class="form-control" style="width: 100%">
                                    <option value="<?php echo $data->company_country;?>"><?php echo $bb['company_country'];?>
                                    </option>
                        ...
                        <div class="form-group row">
                            <label for="company_address_city" class="col-sm-2 col-form-label">
                                <?php echo display('company_address_city') ?>
                            </label>
                            <div class="col-sm-4">
                                <input name="company_address_city" class="form-control" type="text" placeholder="<?php echo display('company_address_city') ?>" id="company_address_city" value="<?php echo $data->company_address_city;?>">
                            </div>
                            <label for="company_address_zip_code" class="col-sm-2 col-form-label">
                                <?php echo display('company_address_zip_code') ?> </label>
                            <div class="col-sm-4">
                                <input name="company_address_zip_code" class="form-control" type="text" placeholder="<?php echo display('company_address_zip_code') ?>" id="company_address_zip_code" value="<?php echo $data->company_address_zip_code;?>">
                            </div>

                        </div>
                        
                        <input type="hidden" name="company_pic_document" value="<?php echo $data->company_pic_document ?>">
                        <input type="hidden" name="company_picture" value="<?php echo $data->company_picture ?>">
