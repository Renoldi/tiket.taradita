<div class="row">
            ...
            <div class="panel-body">
                ...
                <?= form_open('fleet/fleet_type/form/') ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                        <?php echo form_dropdown('type', $fleet_category_list, (!empty($fleet_type->type)?$fleet_type->type:null), ' class="form-control"') ?>
                        </div>
                    </div> 
                           <div class="col-sm-12">
                    <div class="row">
                        ...
                        <option value="hiace-8"  <?php if ($fleet_type->layout == "hiace-8") {echo "selected"; }?>>HiAce 8 Bangku</option>
                        <option value="hiace-10"  <?php if ($fleet_type->layout == "hiace-10") {echo "selected"; }?>>HiAce 10 Bangku</option>
                    ...
                    <div class="col-sm-4"> 
                         <input type="checkbox" id="checkbox" name="lastseat" style="height: 15px;width: 15px" <?php if ($fleet_type->lastseat == "last"){echo ""; }else{
                            echo "checked";
 ...
 if(!empty($total_s) && $fleet_type->layout == "1-1"){
        ...
        if(!empty($total_s) && $fleet_type->layout == "hiace-10"){
                    for($i=1;$i <=$total_s/2;$i++){?>
                        <tr>
                 <td>
                    <?php echo "<img class='img' width='50px' height='50px' src='../../assets/img/f2dcc1cda37a23d4dd30125ebf2ac6ae.png' onerror=this.src='../../../assets/img/f2dcc1cda37a23d4dd30125ebf2ac6ae.png' title='' />";
          ...
          if(!empty($total_s) && $fleet_type->layout == "hiace-8"){
                    for($i=1;$i <=$total_s/2;$i++){?>
                        <tr>
                 <td>
                    <?php echo "<img class='img' width='50px' height='50px' src='../../assets/img/f2dcc1cda37a23d4dd30125ebf2ac6ae.png' onerror=this.src='../../../assets/img/f2dcc1cda37a23d4dd30125ebf2ac6ae.png' title='' />";
