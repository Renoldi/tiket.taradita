<div class="form-group text-right">
    <?php if($this->permission->method('trip', 'create')->access()): ?>
                                ...
                                <?php foreach ($pri as $query) { ?>
                                    <tr class="<?php echo ($sl & 1)?" odd gradeX ":"even gradeC " ?>">
                                        ...
                                        <td class="center">
                                            ...
                                            <a href="<?php echo base_url("trip/price/price_update/$query->price_id") ?>" class="btn btn-xs btn-success"><i class="fa fa-pencil"></i></a> 
                                            <?php endif; ?>


                                            <?php if($this->permission->method('trip', 'delete')->access()): ?>
                                            <a href="<?php echo base_url("trip/price/price_delete/$query->price_id") ?>" class="btn btn-xs btn-danger" onclick="return confirm('<?php echo display('are_you_sure') ?>') "><i class="fa fa-times" aria-hidden="true"></i>
                                            </a> 
                                            <?php endif; ?>
                                        </td>
                                    </tr>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-sm-12 col-md-12">
                        <div class="panel">
                            <div class="panel-body">
                                <?= form_open('trip/price/create_price',array('name'=>'myForm')) ?>
