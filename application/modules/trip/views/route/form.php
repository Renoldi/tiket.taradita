            ...
            <div class="panel-body">
                ...
                <?= form_open('trip/route/form/') ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input name="stoppage_points" class="form-control tokenfield" type="text"  placeholder="<?php echo display('stoppage_points') ?>" id="stoppage_points" value="<?php echo $route->stoppage_points ?>" onclick="showDiv()">
...
<!-- 
           <div id="stopagediv"  style="display:none;height: auto" class="answer_list" >
                    ...
                    <div class="form-group row">
                        <label for="pickup_village" class="col-sm-3 col-form-label">Desa</label>
                        <div class="col-sm-9" hei>
                            <input name="pickup_village" class="form-control" type="text" placeholder="Pisahkan dengan comma" id="pickup_village" value="<?php echo $route->pickup_village ?>">
                        </div>
                    </div>
                    
                    <h4>Pickup</h4>
                    <div class="form-group row">
                        <label for="pickup_district" class="col-sm-3 col-form-label">Kecamatan</label>
                        <div class="col-sm-9" hei>
                            <input name="pickup_district" class="form-control" type="text" placeholder="Pisahkan dengan comma" id="pickup_district" value="<?php echo $route->pickup_district ?>">
                        </div>
                    </div>

                    <div class="form-group row">
                        <label for="drop_village" class="col-sm-3 col-form-label">Desa</label>
                        <div class="col-sm-9" hei>
                            <input name="drop_village" class="form-control" type="text" placeholder="Pisahkan dengan comma" id="drop_village" value="<?php echo $route->drop_village ?>">
                        </div>
                    </div>
                    
                    <h4>Drop</h4>
                    <div class="form-group row">
                        <label for="drop_district" class="col-sm-3 col-form-label">Kecamatan</label>
                        <div class="col-sm-9" hei>
                            <input name="drop_district" class="form-control" type="text" placeholder="Pisahkan dengan comma" id="drop_district" value="<?php echo $route->drop_district ?>">
                        </div>
                    </div>
