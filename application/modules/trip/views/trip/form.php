        ...
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                ...
                <?= form_open('trip/trip/form') ?>
                    ...
                    <div class="form-group row">
                        <label for="fleet_category" class="col-sm-3 col-form-label">Kategori Armada *</label>
                        <div class="col-sm-9">
                            <?php echo form_dropdown('fleet_category', $fleet_category, (!empty($trips->fleet_category)?$trips->fleet_category:null), ' class="form-control trips_info"') ?> 
                        </div>
                    </div> 
                 <div class="form-group row">
