...
public function createbanktransaction($data = [])
	...
	public function getBooking($booking_id_no = null)
	{
    	...
    	return $this->db->select("
                ...
                bh.pickup_trip_village,
                bh.pickup_trip_district,
                bh.drop_trip_location,
                bh.drop_trip_village,
                bh.drop_trip_district,
...
public function getlocal($booking_id_no = null)
    ...
    */ 
    ...
    public function createPassenger($data = array())
	{
	    ...
	    if ($checkExists < 1) 
	    {
			return $this->db->insert_batch("tkt_passenger", $data); 
	    } 
	    else 
	    {
			return $this->db->where('id_no',$checkExists->id_no)
			->update_batch("tkt_passenger", $data); 
	    }
	} 
    ...
    */ 
    ...
    {  
		...
		$rowData = $this->db->select('
		    id_no,trip_id_no, tkt_passenger_id_no, trip_route_id, pickup_trip_location, pickup_trip_village, pickup_trip_district,
		    drop_trip_location, drop_trip_village, drop_trip_district, request_facilities, price,
    	...
    	return $this->db->select("
                ...
                tb.pickup_trip_village,
                tb.pickup_trip_district,
                tb.drop_trip_location,
                tb.drop_trip_village,
                tb.drop_trip_district,
                CONCAT_WS(' ', tp.firstname, tp.lastname) AS passenger_name, 
