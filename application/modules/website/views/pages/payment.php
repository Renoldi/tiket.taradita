...
$bank=$this->db->select('*')->from('bank_info')->get()->result();
 ...
 ?>
   ...
   <span class="container">
    ...
    <li class="active"><button type="button" class="btn btn-primary btn-md ">Registrasi</button></li>
    ...
    <div id="home" class="tab-pane fade in active col-sm-6">
       <div class="passenger-form">
            ...
            <div class="form-group">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <input name="firstname" class="form-control" type="text" placeholder="Nama Depan" id="name" value="<?php echo $this->session->userdata('firstname'); ?>">
                    </div>
                    <div class="col-sm-6">
                        <input name="lastname" class="form-control" type="text" placeholder="Nama Belakang" value="<?php echo $this->session->userdata('lastname'); ?>" id="lastname">
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <input type="text" name="phone" value="<?php echo $this->session->userdata('phone'); ?>" class="form-control" id="phone"  placeholder="Telepon"  >
                    </div>
                    <div class="col-sm-6">
                        <input type="email" name="email" class="form-control" id="email" placeholder="Email"  value="<?php echo $this->session->userdata('email'); ?>">
                    </div>
                </div>
            </div>
            <div class="form-group">
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <input type="password" name="password" class="form-control" id="password" placeholder="Your Password" value="<?php echo $this->session->userdata('password'); ?>" >
                        <input type="hidden" name="old_password" class="form-control" id="old_password" placeholder="Your Password" value="<?php echo $this->session->userdata('password'); ?>">
                    </div>
                    <div class="col-sm-6">
       ...
       <div class="passenger-form">
            <div id="dynamic_field">
                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <input name="firstname1[]" class="form-control" type="text" placeholder="Nama Depan">
                        </div>
                        <div class="col-sm-6">
                            <input name="lastname1[]" class="form-control" type="text" placeholder="Nama Belakang">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="row">
                        <div class="col-sm-12">
                            <label>Identitas</label>
                            <input type="text" name="p_nid1[]" class="form-control" placeholder="KTP/Passport">
                        </div>
                    </div>
                </div>
            </div>
            <div class="form-group" style="text-align: center">
                <div class="row">
                    <div class="col-md-6">
                        <button type="button" name="add" id="add" class="btn btn-success btn-sm">Tambah</button>
                    </div>
                    <div class="col-md-6">
                        <button type="button" name="remove" class="btn btn-danger btn_remove btn-sm">Hapus</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-sm-12">
        <div class="journey-details">
            ...
            <dl class="dl-horizontal">
                ...
                <dt>Lokasi Penjemputan</dt>
                <dd>&nbsp; 
                    <?php echo (!empty($booking->pickup_trip_location)?$booking->pickup_trip_location:null) ?>, <?php echo (!empty($booking->pickup_trip_village)?$booking->pickup_trip_village:null) ?>, <?php echo (!empty($booking->pickup_trip_district)?$booking->pickup_trip_district:null) ?>  
                </dd>
                <dt>Lokasi Pengantaran</dt>
                <dd>&nbsp;  
                    <?php echo (!empty($booking->drop_trip_location)?$booking->drop_trip_location:null) ?>, <?php echo (!empty($booking->drop_trip_village)?$booking->drop_trip_village:null) ?>, <?php echo (!empty($booking->drop_trip_district)?$booking->drop_trip_district:null) ?>
                </dd>
...
<div class="modal fade" id="test_modal" tabindex="-1" role="dialog" style="margin:100px;">
    <div class="modal-md" role="document">
        <div class="modal-content"> 
            ...
            <div class="modal-body">
                 <div class="col-sm-7">
        <a style="background-color:#009b4d;color:white;text-decoration: none;" href="<?php echo base_url('website/website/how_to_pay') ?>"  class="btn btn-block"  onclick="window.open(this.href, '_blank'); return false;"><h4 style="color:white"><?php echo display('how_to_pay');?></h4> </a>
        <br>
        <div class="journey-details">
            ...
            {  
                if (data.exception) {
                    ...
                    passengerMsg.addClass('alert-success').removeClass('alert-danger').html(data.message);
                     ...
                     document.getElementById("old_password").value = data.password;
...
<script>  
 $(document).ready(function(){  
      ...
      $('#add').click(function(){  
           i++;  
           $('#dynamic_field').append('<div id="row'+i+'"> <h4>Detail Penumpang '+i+'</h4><input type="hidden" name="booking_id_no" value="<?php echo (!empty($booking->id_no)?$booking->id_no:null) ?>"> <input type="hidden" name="passenger_id_no" value="<?php echo (!empty($booking->tkt_passenger_id_no)?$booking->tkt_passenger_id_no:null) ?>" id="pid"> <input type="hidden" name="hdn_passenger_id" id="psid" value="<?php echo $this->session->userdata('id_no'); ?>"> <div class="form-group"> <label><?php echo display('name'); ?> *</label> <div class="row"> <div class="col-sm-6"> <input name="firstname1[]" class="form-control" type="text" placeholder="Nama Depan"> </div> <div class="col-sm-6"> <input name="lastname1[]" class="form-control" type="text" placeholder="Nama Belakang"> </div> </div> </div> <div class="form-group"> <div class="row"> <div class="col-sm-12"> <label>Identitas</label> <input type="text" name="p_nid1[]" class="form-control" placeholder="KTP/Passport"> </div> </div> </div> </div>');  
      });  
