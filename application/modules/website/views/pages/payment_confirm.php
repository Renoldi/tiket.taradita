...
<!-- paypal modal end -->
<!-- Bank modal start -->
    <div class="modal fade" id="bank_modal" data-keyboard="false" data-backdrop="static" tabindex="-1" role="dialog" style="margin:100px;">
    <div class="modal-md" role="document">
        <div class="modal-content"> 
            ...
            <div class="modal-body">
               ...
               <input type="hidden" name="company_id" value="<?php echo $booking->company_id ?>">
            <table class="table table table-bordered table-striped">
                <tbody class="itemNumber">
                    <tr>
                        <td class="text-right"><?php echo display('seats'); ?></td>
            ...
            <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                         ...
                         <?php 
                           $bank = $this->db->select('*')->from('bank_info')->where('company_id', $booking->company_id)->get()->result();
                           ?>
                           <?php foreach ($bank as $b) {?>
                           <div class="form-check">
                                <input class="form-check-input" type="radio" value="<?php echo $b->id;?>" name="bank_id" id="bank_id">
                                <label class="form-check-label" for="bank_id">
                                    <?php echo $b->bank_name;?> | <?php echo $b->account_name;?> | <?php echo $b->account_number;?>
                                </label>
                            </div>
                            <?php } ?>
                    </div> 
