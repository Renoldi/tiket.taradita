                ...
                <div class="tools-ber">
                    <div class="row form-block">
                        <form action="<?php echo base_url('website/search') ?>">
                            ...
                            <div class="col-xs-12 col-sm-3 col-md-2">
                                <div class="form-group custom-select">
                                    <?php echo form_dropdown('fleet_category', $fleet_dropdown, $search->fleet_category, array('class' => 'select2 form-control', 'data-placeholder' => display('fleet_type'))) ?>
                                    <i class="fa fa-car"></i>
                                </div>
                            </div>
        ...
        <div class="row tour-content">
            <div class="col-sm-12">
                <div style="text-align: center">
                    <!-- <h3><?php echo $search->start_point ?> <i class="fa fa-arrow-right"></i> <?php echo $search->end_point ?></h3> -->
                    <br>
                    <h5>
                        <b>
                            Asal : <span class="btn btn-success btn-sm" id="dari"> <?php echo $search->start_point ?></span> &nbsp; <span class="glyphicon glyphicon-arrow-right"></span>
                            &nbsp;
                            Tujuan : <span class="btn btn-success btn-sm" id="menujuu"><?php echo $search->end_point ?></span> &nbsp; <span class="glyphicon glyphicon-arrow-right"></span>
                            &nbsp;
                            Tanggal : <span class="btn btn-success btn-sm" id="dantes"><?php echo date('d-m-Y', strtotime($search->date)) ?></span>
                            </span>
                        </b>
                    </h5>
                    <br>
                    <table class="summary-table">
                        <thead>
                            <tr>
                                ...
                                <th scope="col"><?php echo display('company_name') ?></th>
                                <th scope="col"><?php echo display('departure') ?></th>
                                <th scope="col"><?php echo display('duration') ?> Tujuan</th>
                                    ...
                                    <tr>
                                        <td data-label="Operator">
                                            <div class="operator-type">
                                                <h4 class="operator-name" style="font-size: 12px;"><?php echo $trip->trip_route_name ?></h4>
                                            </div>
                                        </td>
                                        <td data-label="Company Name">
                                            <div class="dep-time-counter">
                                                <div class="dep-time"><?php echo $trip->company_name ?></div>
                                                <div class="bus-type"><?php echo $trip->fleet_registration_no ?></div>
                                                <div class="bus-type"><?php echo $trip->fleet_seats . ' Bangku'; ?></div>
                                            </div>
                                        </td>
                                        ...
                                        <td data-label="Operator">
                                            <div class="seat-view">
                                                <button type="button" class="btn btn-info" data-toggle="modal" data-target="#myModal" data-trip-route-id="<?php echo $trip->route ?>" data-trip-id-no="<?php echo $trip->trip_id_no ?>" data-fleet-registration-id="<?php echo $trip->fleet_registration_id ?>" data-fleet-type-id="<?php echo $trip->type ?>" data-booking-date="<?php echo $b_date ?>"><?php echo display('book') ?> </button>
                ...
                <div class="row">
                    <div class="col-sm-5 col-xs-12">
                        ...
                        <div class="price-details">
                            <a style="background-color:#009b4d;color:white;text-decoration: none;" href="<?php echo base_url('website/website/how_to_use') ?>" class="btn btn-block" onclick="window.open(this.href, '_blank'); return false;">
                                <h4 style="color:white"><?php echo display('how_to_use'); ?></h4>
                            </a>
                    ...
                    <div class="col-sm-7 col-xs-12">
                        ...
                        <div class="form-group col-md-12">
                            <label for="pickup_location">Jalan</label>
                            <input name="pickup_location" placeholder="Jalan, RT/RW, Nomor Rumah" class="form-control">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="pickup_village">Desa</label>
                            <select name="pickup_village" id="pickup_village" class="form-control village" style="width:100%"></select>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="pickup_district">Kecamatan</label>
                            <select name="pickup_district" id="pickup_district" class="form-control district" style="width:100%"></select>
                        </div>
                        <h5>Lokasi Pengantaran *</h5>
                        <div class="form-group col-md-12">
                            <label for="drop_location">Jalan</label>
                            <input name="drop_location" placeholder="Jalan, RT/RW, Nomor Rumah" class="form-control">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="drop_village">Desa</label>
                            <select name="drop_village" id="drop_village" class="form-control village1" style="width:100%"></select>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="drop_district">Kecamatan</label>
                            <select name="drop_district" id="drop_district" class="form-control district1" style="width:100%"></select>
                        </div>
                        <div class="form-group">
                            <label for="adult"><?php echo display('passenger') ?></label>
                            <input type="number" name="adult" id="adult" class="form-control seatno" placeholder="Jumlah Penumpang" autocomplete="off" />
                        </div>
        ...
        $('#myModal').on('shown.bs.modal', function(event) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    modal.find('.modal-body .village').html(data.village);
                    modal.find('.modal-body .district').html(data.district);
                    modal.find('.modal-body .village1').html(data.village1);
                    modal.find('.modal-body .district1').html(data.district1);
