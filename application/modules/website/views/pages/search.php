                ...
                <div class="row">
                    <div class="col-sm-5 col-xs-12">
                        ...
                        <div class="price-details">
                             <a style="background-color:#009b4d;color:white;text-decoration: none;" href="<?php echo base_url('website/website/how_to_use') ?>"  class="btn btn-block"  onclick="window.open(this.href, '_blank'); return false;"><h4 style="color:white"><?php echo display('how_to_use');?></h4> </a>
